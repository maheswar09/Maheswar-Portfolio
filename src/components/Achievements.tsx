          ...
          {achievementsData.map((achievement, index) => (
            ...
            >
              <div className="p-3 bg-blue-100 dark:bg-blue-900 rounded-full">
                {achievement.type === 'certification' && <Award className="w-6 h-6 text-blue-600 dark:text-blue-400" />}
                {achievement.type === 'badge' && <BadgeCheck className="w-6 h-6 text-yellow-500 dark:text-yellow-300" />}
                {achievement.type === 'competition' && <Medal className="w-6 h-6 text-green-600 dark:text-green-400" />}
                {achievement.type === 'hackathon' && <Medal className="w-6 h-6 text-purple-600 dark:text-purple-400" />}
              </div>
